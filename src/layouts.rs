...
pub fn MainLayout() -> Element {
    ...
    let title = match route {
        ...
        Route::Devices {} => Some("Manage Devices"),
        Route::Settings {} => Some("Settings"),
        Route::VpnSettingsPage {} => Some("VPN Settings"),
        Route::UiSettingsPage {} => Some("UI Settings"),
        Route::DaitaSettings {} => Some("DAITA"),
        Route::MultihopSettings {} => Some("Multihop"),
        Route::SplitTunnelingSettings {} => Some("Split Tunneling"),
        Route::Support {} => Some("Support"),
        Route::AppInfo {} => Some("App Info"),
        Route::Locations {} => Some("Select Location"),
        _ => None,
    };
