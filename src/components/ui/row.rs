    ...
    rsx! {
        div { 
            ...
            div { 
                ...
                class: if checked { "bg-primary shadow-[0_0_12px_rgba(var(--primary),0.3)]" } else { "bg-muted" },
                div { 
...
#[component]
pub fn MenuRow(label: &'static str, icon: Element, onclick: EventHandler<MouseEvent>) -> Element {
    rsx! {
        div { 
