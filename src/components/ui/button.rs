...
pub fn BackButton() -> Element {
    ...
    rsx! {
        button { 
            class: "w-12 h-12 flex items-center justify-center hover:bg-accent rounded-xl transition-all no-drag text-foreground active:scale-90 shadow-sm border border-transparent hover:border-border",
